...
namespace 程序嵌于任务栏
{
    class TaskbarApp:IDisposable
    {
        ...
        void timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            {
                MoveWindow(hMin, (int)w.ActualWidth + 16, 0, rMin.Right - rMin.Left - (int)w.ActualWidth, rMin.Bottom - rMin.Top, true);
            }), null);
        ...
        public void EmbedTaskbar()
        {
            ...
            MoveWindow(hMin, (int)w.ActualWidth + 16, 0, rMin.Right - rMin.Left - (int)w.ActualWidth, rMin.Bottom - rMin.Top, true);
            MoveWindow(hWnd, 5, 0, (int)w.ActualWidth, (int)w.ActualHeight, true);
            SetParent(hWnd, hBar);
